...
1. [Tibshirani — “Regression Shrinkage and Selection via the Lasso”](https://statweb.stanford.edu/~tibs/lasso/lasso.pdf). Open paper — L1 penalty, sparsity, constrained and penalized forms.
2. [Friedman, Hastie, and Tibshirani — coordinate descent](https://www.jstatsoft.org/article/view/v033i01). Open paper — solver, regularization paths, sparse data, and convergence.
