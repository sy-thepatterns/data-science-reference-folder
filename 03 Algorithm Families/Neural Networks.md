...
2. [Goodfellow, Bengio, and Courville — *Deep Learning*](https://www.deeplearningbook.org/). Open textbook — neural architectures, optimization, regularization, and representation learning.
