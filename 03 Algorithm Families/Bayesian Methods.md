...
3. [Stan User’s Guide](https://mc-stan.org/docs/stan-users-guide/). Open documentation — Bayesian modelling, posterior computation, diagnostics, and predictive checks.
