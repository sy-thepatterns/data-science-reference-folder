...
| Property | Value |
|---|---|
| Primary API | `scipy sparse operations plus custom proximal solver` |
| Fitting style | Proximal gradient or coordinate descent |
| Core solver route | User-selected optimization routine |
| Statistical inference | None automatic |
| Sparse support | Yes for custom route |
...
shape validation and preprocessing
    ↓
Proximal gradient or coordinate descent
    ↓
...
SciPy provides numerical building blocks, not a dedicated elastic-net regression estimator.
