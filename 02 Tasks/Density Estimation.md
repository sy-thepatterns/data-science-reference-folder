...
2. [Scott — *Multivariate Density Estimation* companion materials](https://smoothingbook.sites.rice.edu/). Open author materials — kernel density estimation, bandwidth selection, and multivariate density methods.
