...
1. [Aggarwal — *Recommender Systems* supplementary materials](https://charuaggarwal.net/recommender.htm). Open author materials — collaborative filtering, content methods, evaluation, and system design.
2. [Koren, Bell, and Volinsky — “Matrix Factorization Techniques for Recommender Systems”](https://datajobs.com/data-science-repo/Recommender-Systems-[Netflix].pdf). Open article — latent-factor models, regularization, and implicit feedback.
