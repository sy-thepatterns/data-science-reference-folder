...
1. [Zhang et al. — *Dive into Deep Learning*](https://d2l.ai/). Open textbook — neural networks, optimization, sequence models, attention, computer vision, and implementation examples.
2. [Jurafsky and Martin — *Speech and Language Processing*](https://web.stanford.edu/~jurafsky/slp3/). Open textbook draft — language models, sequence probability, recurrent networks, transformers, and evaluation.
