...
1. [Hyndman and Athanasopoulos — *Forecasting: Principles and Practice*](https://otexts.com/fpp3/). Open textbook — temporal dependence, decomposition, ARIMA, dynamic regression, and evaluation.
2. [statsmodels time-series analysis documentation](https://www.statsmodels.org/stable/tsa.html). Official documentation — statistical time-series models, filters, state space, diagnostics, and tests.
