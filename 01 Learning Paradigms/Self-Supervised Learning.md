...
1. [Balestriero et al. — “A Cookbook of Self-Supervised Learning”](https://arxiv.org/abs/2304.12210). Open survey — contrastive, non-contrastive, clustering, masking, and evaluation methods.
2. [Chen et al. — “A Simple Framework for Contrastive Learning”](https://arxiv.org/abs/2002.05709). Open paper — contrastive objectives, augmentations, temperature, and representation evaluation.
