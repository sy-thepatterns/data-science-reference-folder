...
1. [Zhu — *Semi-Supervised Learning Literature Survey*](https://pages.cs.wisc.edu/~jerryzhu/pub/ssl_survey.pdf). Open survey — generative, graph-based, self-training, and co-training methods.
2. [Sohn et al. — “FixMatch”](https://arxiv.org/abs/2001.07685). Open paper — pseudo-label confidence and consistency regularization.
