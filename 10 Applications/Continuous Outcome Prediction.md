...
1. [James et al. — *An Introduction to Statistical Learning*](https://www.statlearning.com/). Open textbook — accessible statistical explanations, resampling, regression, classification, trees, support vector machines, and unsupervised learning.
2. [TRIPOD Statement](https://www.tripod-statement.org/). Open reporting guidance — prediction-model development, validation, transparency, and reporting.
3. [Steyerberg — Clinical Prediction Models course materials](https://www.clinicalpredictionmodels.org/). Open author resources — prediction modelling, validation, calibration, and decision use.
