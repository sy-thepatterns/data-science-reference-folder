...
1. [Stanford EE263 — Least Squares](https://web.stanford.edu/~boyd/ee263/lectures/least-squares.pdf). Open lecture notes — projection, normal equations, geometry, and applications.
2. [LAPACK Users’ Guide — least-squares problems](https://www.netlib.org/lapack/lug/node27.html). Open numerical reference — dense solver families, rank deficiency, and computational choices.
